                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('transaction.index') }}" class="btn btn-sm btn-primary">Lihat Semua Data Transaksi</a>
                            </div>
                        </div>
                        <div class="m-t-30">
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach ($latestTransactions as $transaction)
                                        <tr>
                                            ...
                                            <td>Rp {{ number_format($transaction->package->price ?? 0, 0, ',', '.') }}</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @php
                                                    ...
                                                    @endphp
                                                    <span class="badge {{ $badgeClass }} badge-dot m-r-10"></span>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('paket.index') }}" class="btn btn-sm btn-primary">Lihat Data Paket</a>
                            </div>
                        </div>
                        <div class="m-t-30">
                                ...
                                <li class="list-group-item p-h-0">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex">
                                            <div>
                                                <h6 class="m-b-0">
                                                    <a href="javascript:void(0);" class="text-dark">{{ $package->name ?? '-' }}</a>
                                                </h6>
                                        ...
                                        <span class="badge badge-pill badge-cyan font-size-12">
                                            <span class="font-weight-semibold">{{ $item->total_sales }} transaksi</span>
                                        </span>
                                    </div>
                                </li>
                            @empty
