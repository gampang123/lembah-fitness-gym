            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href={{ route('dashboard') }}>
                        <img class="w-90" src="{{ asset('asset/logo2.png') }}" alt="Logo">
                    </a>
                </div>
                <div class="logo logo-white">
                    <a href={{ route('dashboard') }}>
                        <img class="w-20" src="{{ asset('asset/logo.png') }}" alt="Logo">
                    </a>
                </div>
                <div class="nav-wrap">
                    <ul class="nav-left">
            ...
            <div class="side-nav">
                <div class="side-nav-inner">
                    <ul class="side-nav-menu scrollable">
                        ...
                        {{-- Paket --}}
                        <li class="nav-item dropdown {{ request()->is('paket*') ? 'active' : '' }}">
                            <a class="dropdown-toggle" href="javascript:void(0);">
                                <span class="icon-holder">
                        ...
                        {{-- Transaksi --}}
                        <li class="nav-item dropdown {{ request()->routeIs('transaction.index') ? 'active' : '' }}">
                        ...
                        {{-- Presensi --}}
                        <li class="nav-item dropdown {{ request()->routeIs('presence.index') ? 'active' : '' }}">
                    ...
                    <div class="modal-body scrollable">
                        ...
                        <div class="m-t-30">
                            ...
                            <div class="d-flex m-b-30">
                                ...
                                <div class="m-l-15">
                                    <a href="javascript:void(0);"
                                        class="text-dark m-b-0 font-weight-semibold">{{ Auth::user()->name }}</a>
